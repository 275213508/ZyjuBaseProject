...
public class OkhttpUtil {
    ...
    private static OkhttpUtil  inst ;
     ...
     */
    public  synchronized void okHttpGet(String url, CallBackUtil callBack) {
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public   synchronized void okHttpGet(String url, Map<String, String> paramsMap, CallBackUtil callBack) {
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public  synchronized void okHttpGet(String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtil callBack) {
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public  synchronized void okHttpPost(String url, CallBackUtil callBack) {
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public  synchronized void okHttpPost(String url, Map<String, String> paramsMap, CallBackUtil callBack) {
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public  synchronized void okHttpPost(String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtil callBack) {
...
/**
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public  synchronized void okHttpPut(String url, CallBackUtil callBack) {

...
//                    ss = Luban.with(CommonUtils.getContext()).load(str).setTargetDir(CommonUtils.getPublicFileDownDir()).ignoreBy(ZoomIgnoreBy).get();
//                } catch (IOException e) {
//                }
//                return BitmapFactory.decodeFile(ss.get(0).getAbsolutePath());
